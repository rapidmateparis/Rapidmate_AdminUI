    ...
    <ScrollView style={{flex: 1, backgroundColor: '#F9FBFD'}}>
      <View style={{paddingHorizontal: 15}}>
        ...
        <View style={styles.textInputDiv}>
          <Text style={styles.formTitle}>Vehicle title</Text>
          <TextInput
        ...
        <View style={styles.textInputDiv}>
          <Text style={styles.formTitle}>Vehicle capacity (liter)</Text>
          <TextInput
          style={styles.loginput}
          placeholder="Type here.."
          placeholderTextColor="#999"
        ...
        <View>
          <View style={styles.bookAddress}>
            <Text style={styles.cardTitle}>Make this vehicle available</Text>
